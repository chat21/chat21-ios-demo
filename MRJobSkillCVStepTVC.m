//
//  MRJobSkillCVStepTVC.m
//  misterlupo
//
//  Created by Andrea Sponziello on 30/06/16.
//  Copyright © 2016 Frontiere21. All rights reserved.
//

#import "MRJobSkillCVStepTVC.h"

@interface MRJobSkillCVStepTVC ()

@end

@implementation MRJobSkillCVStepTVC
...
- (void)viewDidLoad {
    ...
    self.titleLabel.text = NSLocalizedString(@"your resume", nil);
    self.subtitleLabel.text = NSLocalizedString(@"your resume subtitle", nil);
    self.navigationItem.title = NSLocalizedString(@"working experience", nil);
...
-(void)saveDescription:(NSString *)description {
    ...
    [userPreferences setObject:self.descriptionTextView.text forKey:@"jobWizardDescription"];
    [userPreferences synchronize];
}

-(NSString *)loadDescription {
    NSUserDefaults *userPreferences = [NSUserDefaults standardUserDefaults];
    return [userPreferences stringForKey:@"jobWizardDescription"];
}
