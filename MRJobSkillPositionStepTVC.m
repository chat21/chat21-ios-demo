...
#import "MRJobSkillPositionStepTVC.h"

@interface MRJobSkillPositionStepTVC ()

@end

@implementation MRJobSkillPositionStepTVC
...
- (void)viewDidLoad {
    ...
    self.capTextView.placeholder = NSLocalizedString(@"skill where placeholder", nil);
    self.nextButton.title = NSLocalizedString(@"next", nil);
    self.titleLabel.text = NSLocalizedString(@"skill where", nil);
    self.subtitleLabel.text = NSLocalizedString(@"skill where subtitle", nil);
    self.subtitle2Label.text = NSLocalizedString(@"skill where subtitle2", nil);
    self.placeholderLabel.text = NSLocalizedString(@"skill where placeholder", nil);
    self.navigationItem.title = NSLocalizedString(@"skill where", nil);
