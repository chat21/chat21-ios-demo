...
@interface MRJobSkillStepTVC ()

@end

@implementation MRJobSkillStepTVC
...
- (void)viewDidLoad {
    ...
    if (self.category) {
        ...
        // categories from root
        NSLog(@"building categories tree");
    ...
    if (!self.category) {
        ...
        self.navigationItem.title = NSLocalizedString(@"want work view title", nil);
    }
    else {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        titleLabel.text = NSLocalizedString(@"select skill", nil);
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        ...
        if (selectedCategory.children) {
            ...
            MRJobSkillStepTVC *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"skill-vc"];
